...
def update_disponibilidad(
    db: Session, disponibilidad_id: int, disponibilidad_data: DisponibilidadUpdate
):
    disponibilidad = get_disponibilidad(db, disponibilidad_id)
    if disponibilidad_data.descripcion_disponibilidad:
        disponibilidad.descripcion_disponibilidad = (
            disponibilidad_data.descripcion_disponibilidad
        )
    db.commit()
