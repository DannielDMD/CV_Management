...
class Disponibilidad(Base):
    ...
    preferencias = relationship("PreferenciaDisponibilidad", back_populates="disponibilidad")
...
class RangoSalarial(Base):
    ...
    # Relación con Preferencias y Disponibilidad
    preferencias = relationship("PreferenciaDisponibilidad", back_populates="rango_salarial")
...
class MotivoSalida(Base):
    ...
    # Relación con Preferencias y Disponibilidad
    preferencias = relationship("PreferenciaDisponibilidad", back_populates="motivo_salida")
...
class PreferenciaDisponibilidad(Base):
    ...
    id_disponibilidad_inicio = Column(Integer, ForeignKey("disponibilidad.id_disponibilidad"), nullable=False)
    id_rango_salarial = Column(Integer, ForeignKey("rangos_salariales.id_rango_salarial"), nullable=False)
